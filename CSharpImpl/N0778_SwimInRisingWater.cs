...
namespace CSharpImpl
{
    ...
    /// Output: 16
    /// Explanation:
    /// 0 1 2 3 4 24 23 22 21 5
    /// 12 13 14 15 16
    /// 11 17 18 19 20
    /// 10 9 8 7 6 The final route is marked in bold. We need to wait until time 16 so that (0, 0) and (4, 4) are connected.
    /// 
    /// Note:
    /// 1. 2 <= N <= 50.
    ...
    /// 
    /// </summary>
    public class N0778_SwimInRisingWater
    {
