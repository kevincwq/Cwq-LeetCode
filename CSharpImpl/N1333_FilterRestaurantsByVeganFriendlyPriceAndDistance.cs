...
namespace CSharpImpl
{
    ...
    /// Restaurant 5 [id=5, rating=1, veganFriendly=1, price=15, distance=1] After filter restaurants with veganFriendly = 1, maxPrice = 50 and maxDistance = 10 we have restaurant 3, restaurant 1 and restaurant 5 (ordered by rating from highest to lowest).
    /// 
    /// Example 2:
    ...
    /// 
    /// </summary>
    public class N1333_FilterRestaurantsByVeganFriendlyPriceAndDistance
    {
