...
namespace CSharpImpl
{
    ...
    /// 1  3  5 ﹈ ﹈ ﹈
    /// D.popAtStack(0); // Returns 20. The stacks are now: 4 21   1  3  5 ﹈ ﹈ ﹈
    /// D.popAtStack(2); // Returns 21. The stacks are now: 4   1  3  5 ﹈ ﹈ ﹈ D.pop() // Returns 5. The stacks are now: 4   1  3 ﹈ ﹈ D.pop() // Returns 4. The stacks are now: 1  3 ﹈ ﹈ D.pop() // Returns 3. The stacks are now: 1 ﹈ D.pop() // Returns 1. There are no stacks.
    ...
    /// 
    /// </summary>
    public class N1172_DinnerPlateStacks
    {
