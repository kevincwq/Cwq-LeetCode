...
namespace CSharpImpl
{
    ...
    /// 
    /// Example 1:
    /// [<https://assets.leetcode.com/uploads/2020/06/17/ants.jpg>]Input: n = 4, left = [4,3], right = [0,1]
    /// Output: 4
    ...
    /// 
    /// Example 2:
    /// [<https://assets.leetcode.com/uploads/2020/06/17/ants2.jpg>]Input: n = 7, left = [], right = [0,1,2,3,4,5,6,7]
    /// Output: 7
    /// Explanation: All ants are going to the right, the ant at index 0 needs 7 seconds to fall.
    /// 
    /// Example 3:
    /// [<https://assets.leetcode.com/uploads/2020/06/17/ants3.jpg>]Input: n = 7, left = [0,1,2,3,4,5,6,7], right = []
    /// Output: 7
    ...
    /// 
    /// </summary>
    public class N1503_LastMomentBeforeAllAntsFallOutOfAPlank
    {
