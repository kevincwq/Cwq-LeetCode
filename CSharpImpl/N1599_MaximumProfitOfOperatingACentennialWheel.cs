...
namespace CSharpImpl
{
    ...
    /// 
    /// Example 1:
    /// [<https://assets.leetcode.com/uploads/2020/09/09/wheeldiagram12.png>]Input: customers = [8,3], boardingCost = 5, runningCost = 6
    /// Output: 3
    ...
    /// 
    /// </summary>
    public class N1599_MaximumProfitOfOperatingACentennialWheel
    {
