...
{
    public class UT_N37_SodoluSolver
    {
        static readonly object[] TestCases1 =
        {
            new object[]{
                new char[][] {
                    new char[]{'5','3','.','.','7','.','.','.','.'},
        ...
        static readonly object[] TestCases2 =
        {
            new object[]{
                new char[][] {
                    new char[]{'.','.','9','7','4','8','.','.','.'},
        ...
        static readonly object[] TestCases3 =
{
            new object[]{
                new char[][] {
                    new char[]{'.','1','.','.','4','8','6','.','2'},
        ...
        {
            var so = new N37_SodokuSolver.Solution1();
