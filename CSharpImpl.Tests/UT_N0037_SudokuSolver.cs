...
{
    public class UT_N0037_SudokuSolver
    {
        ...
        static readonly object[] S1_TestCases3 =
{
        ...
        public void Solution1_1(char[][] board, char[][] expected)
        {
            var so = new N0037_SudokuSolver.Solution1();
            so.SolveSudoku(board);
            Assert.IsTrue(TestHelper.AreEqual(board, expected));
        }

        [TestCaseSource(nameof(S1_TestCases2))]
        public void Solution1_2(char[][] board, char[][] expected)
        {
            var so = new N0037_SudokuSolver.Solution1();
            so.SolveSudoku(board);
            Assert.IsTrue(TestHelper.AreEqual(board, expected));
        ...
        public void Solution1_3(char[][] board, char[][] expected)
        {
            var so = new N0037_SudokuSolver.Solution1();
            so.SolveSudoku(board);
            Assert.IsTrue(TestHelper.AreEqual(board, expected));
        ...
        static readonly object[] S2_TestCases3 =
{
        ...
        public void Solution2_1(char[][] board, char[][] expected)
        {
            var so = new N0037_SudokuSolver.Solution2();
            so.SolveSudoku(board);
            Assert.IsTrue(TestHelper.AreEqual(board, expected));
        }

        [TestCaseSource(nameof(S2_TestCases2))]
        public void Solution2_2(char[][] board, char[][] expected)
        {
            var so = new N0037_SudokuSolver.Solution2();
            so.SolveSudoku(board);
            Assert.IsTrue(TestHelper.AreEqual(board, expected));
        ...
        public void Solution2_3(char[][] board, char[][] expected)
        {
            var so = new N0037_SudokuSolver.Solution2();
            so.SolveSudoku(board);
            Assert.IsTrue(TestHelper.AreEqual(board, expected));
